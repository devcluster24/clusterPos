...
const NavMenuButton: React.FC<NavMenuButtonProps> = ({
  ...
  return (
    <button
      className="flex items-center border border-gray-300  rounded text-gray-700 dark:text-gray-200 hover:bg-blue-100 dark:hover:text-gray-700 transition group lg:min-w-56 md:min-w-[48%] sm:min-w-[48%]  xs:min-w-full hover:border-blue-300 hover:cursor-pointer"
      onClick={onClick}
    >
